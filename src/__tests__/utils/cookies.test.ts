...
describe('cookie utilities', () => {
  ...
  describe('setCookie', () => {
    ...
    it('sets a cookie with options', () => {
      setCookie('test', 'value', { path: '/', domain: 'example.com', sameSite: 'Lax', secure: true });
  ...
  describe('isLocalStorageAvailable', () => {
    ...
    it('returns false when localStorage throws', () => {
      ...
      Object.defineProperty(window, 'localStorage', { get: () => original, configurable: true });
    });
  });
  ...
  describe('isSessionStorageAvailable', () => {
    ...
    it('returns false when sessionStorage throws', () => {
      ...
      Object.defineProperty(window, 'sessionStorage', { get: () => original, configurable: true });
    });
  });
});
